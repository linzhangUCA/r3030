...
class VelocityControllerInterface(Node):
    """
    A ROS interface for the Robot3030
    """

    def __init__(self):
        super().__init__("r3030_driver_interface")
        ...
        # constants
        self.GROUND_CLEARANCE = 0.3
        self.get_logger().info("R3030 driver is up.")
...
def main(args=None):
    ...
    driver_interface = VelocityControllerInterface()
    rclpy.spin(driver_interface)
    driver_interface.destroy_node()
    rclpy.shutdown()
